...
public final class PostgresAttachFailures {
    ...
    public static PostgresAttachException attachFailure(
            final PostgresLayout layout, final PostgresInstanceMetadata metadata, final AttachResult result) {
        ...
        return new PostgresAttachException(
                "Existing PostgreSQL metadata could not be attached safely", new DiagnosticReport(sections));
    }
}
