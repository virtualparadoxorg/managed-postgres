...
final class DownloadedRuntimeDslTest {
    ...
    void officialRepositoryConfiguresDownloadedRuntime() {
        final AbstractManagedPostgresBuilder builder = (AbstractManagedPostgresBuilder)
                ManagedPostgres.create().version("18.4").withDownloadedRuntime().fromOfficialRepository();
    ...
    void gitHubReleaseConfiguresDownloadedRuntime() {
        final AbstractManagedPostgresBuilder builder = (AbstractManagedPostgresBuilder)
                ManagedPostgres.create().version("18.4").withDownloadedRuntime().fromGitHubRelease("acme", "pgr");
