...
import eu.virtualparadox.managedpostgres.spring.boot3.health.ManagedPostgresHealthIndicator;
...
/**
 * Spring Boot 3 auto-configuration exposing managed PostgreSQL bootstrap handles as beans.
 */
@AutoConfiguration
